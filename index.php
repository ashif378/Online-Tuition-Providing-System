...
<!--<ul class="nav navbar-nav navbar-midlle">-->
 ...
 <form class="navbar-form navbar-left">
  ...
  <section class="container-fluid" style="background:#001834;min-height: 550px;margin-top:52px ">
   <br><br><br> <header style="text-align: center;color: white;font-size: 52px;font-weight: bold">Ashif Academy</header>
     <div class="container">
       <p style="color: white;font-size: 24px;padding-left: 95px">Online Tution Provider Is Most Popular Website For Finding Qualified Teacher And</p>
       <p style="color: white;font-size: 24px;padding-left: 185px"> It's Also Provide Easy To Find Student Who Is Seeking Tution.</p>
     </div>
    ...
    <div class="container" style="max-width:200px ;float:left;">
     ...
     <div class="container" style="max-width:200px ;float: left;">
        <img style="max-width: 220px ;max-height: 150px" class="img-circle" src="image/p5.jpg">
         <h4><a href="#"> Communication With Provider</a></h4>
     </div>
   </div>
