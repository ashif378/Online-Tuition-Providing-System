...
<input type="text" name="district" class="form-control" placeholder="District" id="" required>

<input type="text" name="thana_upazila" class="form-control" placeholder="Thana/Upazila" id="" required>
