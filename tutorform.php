...
<input type="text" class="form-control" name="district" placeholder=" District *" id="" required>
</select>
<input type="text" class="form-control" name="thana_upazila" placeholder=" Thana/Upazila *" id="" required>
</select>
